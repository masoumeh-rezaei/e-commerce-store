                        ...
                        activeStep === 1 ? (
                            cartItems.map((cartItem) => (
                                ...
                                <div className={'flex items-center justify-between'}  key={cartItem.id + cartItem.selectedSize + cartItem.selectedColor}>
                                    ...
                                    {/*delete button*/}
                                    <button className={'w-8 h-8 hover:bg-red-200 transition-all duration-200 rounded-full bg-red-100 text-red-400 flex items-center justify-center cursor-pointer'}>
